...
<div id="wrapper">
    ...
    <!-- Section 01 -->
    <section class="mainpage_section1">
        <div class="mainpage_section1_Title">
            <h2>What we will do</h2>
        </div>
        <div class="mainpage_section1_Content">
            <p> Recycle Rewards is dedicated to creating a more environmentally educated and sustainable community. <br><br>
                Through our unique and innovative platform, we facilitate individuals, classrooms and entire schools to actively
                work together to collect recyclable materials and dispose of them at our clean, safe, designated drop-off areas. <br><br>
                Each user will collect points for every bag of recyclable material that is collected and dropped off. Points can be saved
                and redeemed to earn unique and exciting prizes across the city. <br><br>
                Whether it is free cinema tickets, discounted passes to Toronto landmarks such as the CN Tower,
                or vouchers for free meals at exclusive restaurants; each reward is earned with a sense of pride
    ...
    <img src="img/think-green.jpg" id="aside_picture">



    <!--  Section 03(Panel Decompose)-->
    <section class="mainpage_section2">
        <div class="mainpage_section2_Title">
            <h2>How Long Does It Take Garbage to Decompose?</h2>
        </div>
        <div class="mainpage_section2_Content">
            <ul>
                    ...
                    <div id="openModal3" class="modalDialog3">
                        <div>
                            ...
                            <p>Aluminum cans take 80-200 years in landfills to get completely decomposed<br><br>
                                ...
                                But, at the same time, in every three-month period, enough aluminum cans are thrown
                    ...
                    <div id="openModal5" class="modalDialog5">
                        <div>
                            ...
                            <p> By weight, food waste is the largest waste item in American landfills.<br><br>
                                The time taken for food waste decomposing depends on the type of food.<br><br>
                ...
                <li><a href="#openModal6">Glass</a><br>
                    <div id="openModal6" class="modalDialog6">
                        <div>
                            <a href="#close" title="Close" class="close">X</a>
                            <h2>Glass</h2>
                            <p>And according to some sources, glass does not decompose at all.<br><br>
                                ...
                                landfills, it takes million years to decompose. <br><br>
                            </p>
                        </div>
                    </div>
                </li>
                    ...
                    <div id="openModal7" class="modalDialog7">
                        <div>
                            ...
                            <p>Normally, plastic items can take up to 1000 years to decompose in landfills.<br><br>
                                ...
                                According to an estimate, every year we use approximately 1.6 million barrels of oil just for producing plastic water bottles.</br><br>
                                Plastic waste is one of many types of wastes that take too long to decompose.<br> <br></p>
                        </div>
                    </div>
                </li>
                <li><a href="#openModal8">Plastic Waste</a><br>
                    <div id="openModal8" class="modalDialog8">
                        <div>
                            <a href="#close" title="Close" class="close">X</a>
                            <h2>Plastic Waste</h2>
                            <p> Normally, it takes 2-6 weeks in landfills to get completely decomposed.<br><br>
                                Based on volume, paper the largest element in American landfills.<br><br>
                                But if we recycle paper items, we can easily save lot of landfill space, while reducing the energy and virgin material
                ...
                <li><a href="#openModal">Why we Recycled</a><br>
                    <div id="openModal" class="modalDialog">
                        <div>
                            ...
                            <p>Recycling is a very important practice that can help the negative impact that waste has upon our natural environment. <br>
                                The act of recycling preserves the resources that are used by society.<br><br>
                                In essence, everything that is needed for our well-being and survival has a direct impact upon our planet. <br><br>
                                The act of recycling ensures that society does not over use, deplete, or dispose of material in a way that harms the
                                planets equilibrium. <br><br>
                    ...
                    <div id="openModal2" class="modalDialog2">
                        <div>
                            ...
                            <ul>
                                ...
                                <li>Separate plastic bags/over-wrap from newspapers, flyers, magazines, water/soft drink cases. Recycle separately.</li>
                            </ul>
                        </div>
                    </div>
                </li>
